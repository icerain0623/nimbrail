...
| `cirrus` | 逐次的なリサーチノート。見つけた時点で Obsidian に残るので、コンテキストが死んでも再開できる。閉じるときに結論を読み手の問いの順に書き直し、記録を読まなくても成り立つようにする |
